...
if(isset($_POST["add_book"]))
{
	...
	if($error == '')
	{
		...
		$query = "
		INSERT INTO book 
        (book_category, book_author,  book_name, book_isbn_number, book_no_of_copy, book_status) 
        VALUES (:book_category, :book_author, :book_name, :book_isbn_number, :book_no_of_copy, :book_status)
		";
        			...
        			foreach($statement->fetchAll() as $row)
        			{
        				...
        				<tr>
        					...
        					<td>
        						...
        						<button type="button" name="delete_button" class="btn btn-danger btn-sm" onclick="delete_data(`'.$row["book_id"].'`, `'.$row["book_status"].'`)">Change Status</button>
        					</td>
        				</tr>
        				';
        			}
